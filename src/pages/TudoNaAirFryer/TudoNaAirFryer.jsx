            ...
            <body style={{ fontSize: "16px", margin: "20px" }}>
                ...
                <p>
                    <span style={{ color: "#f0f0f0" }}>
                        ...
                        Tudo na AirFryer respeitar a sua privacidade em relação
                        a qualquer informação sua que possamos coletar no site{" "}
                        <a
                            href="https://www.jaomanoel.online/"
                            style={{ color: "#f0f0f0" }}
                        >
                            Tudo na AirFryer
                        </a>
                ...
                <p>
                    <span style={{ color: "#f0f0f0" }}>
                        ...
                        conteúdos e da informação que o Tudo na AirFryer oferece
                ...
                <ul>
                    ...
                    <li>
                        <span style={{ color: "#f0f0f0" }}>
                            ...
                            e lógicos (softwares) do Tudo na AirFryer, de seus
                ...
                <h3>
                    <span style={{ color: "#ffffff" }}>Mais informações</span>
                </h3>
                <p>
                    <span style={{ color: "#f0f0f0" }}>
                ...
                <p>
                    <span style={{ color: "#f0f0f0" }}>
                        Esta política é efetiva a partir de&nbsp;22 October 2024
                        19:53
                    </span>
                </p>
            </body>
