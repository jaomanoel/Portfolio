                    ...
                    <div className="flex items-center w-[90vw] md:w-full h-full gap-12 md:gap-24">
                        ...
                        <div className="flex flex-col items-center gap-12">
                            <p className="text-neutral md:text-xl text-base">
                                Tenho 16 anos atualmente, estou no segundo ano
                                do novo Ensino Médio e sou um entusiasta da área
                                de Tecnologia da Informação (TI). Desde criança,
                                sempre tive interesse em entender como os
                                sistemas funcionam e como a tecnologia pode
                                ajudar as pessoas.
                            </p>
                            ...
                            <p className="text-neutral md:text-xl text-base">
                                ...
                                desenvolvendo pequenos projetos e ampliando meus
                                conhecimentos em linguagens de programação como
                                Java, TypeScript e JavaScript.
                            </p>

                            <p className="text-neutral md:text-xl text-base">
                                Tenho muita vontade de aprender mais e me manter
                                atualizado com as novas tendências e tecnologias
                                do mercado. Acredito que o aprendizado contínuo
                                é fundamental para o sucesso na área de TI e
                                estou sempre buscando novas oportunidades de
